...
object Constants {
    ...
    const val FLYWHEEL_P            = 0.0//0.12//0.2
    const val FLYWHEEL_I            = 0.0//0.006//0.0
    const val FLYWHEEL_D            = 0.0//7.0//4.0
    const val FLYWHEEL_F            = 0.028221//0.03104109
    const val FLYWHEEL_IZONE        = 30
    const val FLYWHEEL_RAMP_RATE    = 0.0

    const val ROTATOR_P             = 0.4
