...
object Constants {
    ...
    const val FLYWHEEL_P            = 0.26//0.2
    const val FLYWHEEL_I            = 0.012//0.0
    const val FLYWHEEL_D            = 16.0//4.0
    const val FLYWHEEL_F            = 0.03211147//0.03104109
    const val FLYWHEEL_IZONE        = 50
