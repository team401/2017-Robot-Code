...
public class MagicProfiles {
	...
	public static double[][] get(String start, String tgt, boolean mecanum, boolean alliance) {
		...
		return mecanum ?
				new double[][]{
						//Mecanum drive
						scanCSV("/home/mecanummagic/"+start+tgt+all+" FL"),
						scanCSV("/home/mecanummagic/"+start+tgt+all+" FR"),
						scanCSV("/home/mecanummagic/"+start+tgt+all+" RL"),
						scanCSV("/home/mecanummagic/"+start+tgt+all+" RR")
				}: new double[][]{
				//Tank drive
				scanCSV("/home/tankmagic/"+start+tgt+all+" L"),
				scanCSV("/home/tankmagic/"+start+tgt+all+" R")
		};
	}
